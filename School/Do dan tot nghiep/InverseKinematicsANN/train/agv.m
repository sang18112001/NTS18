...
E_tinhlai_matrix = zeros(num_iterations, 3);
q_tinhlai_matrix = zeros(num_iterations, 3);
...
for idx = 1:num_iterations
    ...
    E_tinhlai_matrix(idx, :) = [xE_tinhlai, yE_tinhlai, zE_tinhlai];
    q_tinhlai_matrix(idx, :) = [q1, q2, q3];
    %% Ve do thi
